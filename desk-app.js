...
(function(){
  ...
  const specs={
    h_ear:['Ear height',20,80,.5,'cm'],h_woofer:['Woofer height',-20,80,.5,'cm'],tweeter_offset:['Tweeter height offset',-50,50,.5,'cm'],D:['Listening distance D',60,250,1,'cm'],theta:['Triangle half-angle',10,45,.5,'°'],tilt:['Cabinet tilt',-20,20,.5,'°'],desk_near:['Desk near edge',0,60,1,'cm'],desk_far:['Desk far edge',20,120,1,'cm'],desk_width:['Desk width',40,300,2,'cm'],
    absorber_near:['Patch near edge',0,100,1,'cm'],absorber_far:['Patch far edge',5,120,1,'cm'],absorber_thickness:['Patch thickness',1,15,.5,'cm'],absorber_sigma:['Flow resistivity',3000,60000,500,'Pa·s/m²'],rigid_R:['Bare desk R',0,1,.01,''],piston_radius:['Woofer piston radius',2,15,.5,'cm'],c:['Speed of sound',330,350,.5,'m/s'],crossover:['LR crossover',500,5000,50,'Hz'],crossover_order:['Crossover order',2,8,2,''],band_lo:['Comb band low',100,2000,50,'Hz'],band_hi:['Comb band high',500,10000,100,'Hz']
  };
  ...
  function mountControls(){
    ['h_ear','h_woofer','tweeter_offset','D','theta','tilt','desk_near','desk_far','desk_width'].forEach(n=>$('geometryControls').append(control(n)));
  ...
  function applyPreset(name){state={...state,...({reference:{h_ear:48,h_woofer:29.5,tweeter_offset:20,D:120,theta:30,tilt:0},lowered:{h_woofer:14.5,tilt:10},raised:{h_woofer:59.5,tilt:-8},ear:{h_woofer:48,tilt:0}}[name]||{})};syncControls();updateGeometryOnly();computeNow()}
